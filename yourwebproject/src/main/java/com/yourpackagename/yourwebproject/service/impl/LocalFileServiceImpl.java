...
import com.yourpackagename.yourwebproject.service.LocalFileService;
...
@Service
@Transactional
public class LocalFileServiceImpl implements LocalFileService, InitializingBean, ResourceLoaderAware {
	...
	private static final Log logger = LogFactory.getLog(LocalFileServiceImpl.class);
